...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Door") && isMainDoorUnlocked)
        {
    ...
    private void OnCollisionEnter(Collision collision)
    {
        if (collision.transform.CompareTag("Enemy"))
        {
            ...
            FindAnyObjectByType<DeadCamera>().Dead();
...
public class FirstPersonControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        #region Game Director Reference

        EditorGUILayout.Space();
        EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
        GUILayout.Label("Game Setup", new GUIStyle(GUI.skin.label)
        {
        ...
        fpc.gameDirector = (GameDirector)EditorGUILayout.ObjectField(
            new GUIContent("Game Director", "Oyun kontrolcüsünü buraya atayın."),
            fpc.gameDirector,
            typeof(GameDirector),
            true
        );
        ...
        #endregion
        #region isMainDoorUnlocked Reference



        fpc.isMainDoorUnlocked = EditorGUILayout.Toggle(
            new GUIContent("isMainDoorUnlocked", "Ana kapının kilidinin açık olup olmadığını belirler."),
            fpc.isMainDoorUnlocked
        );
